...
typedef struct COLINFO {
  ...
  WORD xf;
  WORD flags;
  /* There should be an unused WORD field at the end here. However, some files
   * in the wild report it as a BYTE, which results in a boundary-check parse
   * error. Since the value is ignored anyway, we'll just pretend it was never
   * there.
   *
