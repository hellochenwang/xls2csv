...
record_brdb brdb[] = {
    ...
    {0xEF, "PHONETIC-INFO",
     "Specifies the default format for phonetic strings "},
    ...
    {0x4BC, "?FORMULA-RELATED=?(BC=SHRFMLA))",
     "Formula related, always before there are 0x06 (FORMULA)"},
